<template>
  <div class="container py-24 mx-auto prose dark:prose-invert">
    <h2><strong>Terms and Conditions</strong></h2>

    <p>Welcome to OpenformStack!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Zeitalabs's Website, located at https://www.openformstack.com/.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use OpenformStack if you do not agree to take all of
    ...
    <p>
      We employ the use of cookies. By accessing OpenformStack, you agreed to
      use cookies in agreement with the Zeitalabs's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Zeitalabs and/or its licensors own the
      intellectual property rights for all material on OpenformStack. All
      intellectual property rights are reserved. You may access this from
      OpenformStack for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from OpenformStack</li>
      <li>Sell, rent or sub-license material from OpenformStack</li>
      <li>Reproduce, duplicate or copy material from OpenformStack</li>
      <li>Redistribute content from OpenformStack</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Zeitalabs does
      ...
      Zeitalabs,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Zeitalabs shall not be liable for the
    ...
    <p>
      Zeitalabs reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Zeitalabs a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Zeitalabs; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Zeitalabs. Please include your name, your organization name,
    ...
    <p>
      No use of Zeitalabs's logo or other artwork will be allowed for linking
