<template>
  <div class="container py-24 mx-auto prose dark:prose-invert">
    ...
    <p>Thank you for shopping at OpenformStack.</p>
    <p>
    ...
    <ul>
      <li>
        <p>
          ...
          this Agreement) refers to Zeitalabs, 14-164/2, Laxmi Nagar,
          Chinamushidivada, Pendurthi, Visakhapatnam, 531173.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to OpenformStack, accessible from
          <a
            href="https://www.openformstack.com/"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.openformstack.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: naveen@zeitalabs.com</li>
    </ul>
    <p>
    ...
    <p>
      14-164/2, Laxmi Nagar, Chinamushidivada, Pendurthi, Visakhapatnam, 531173
    </p>
    <p>
